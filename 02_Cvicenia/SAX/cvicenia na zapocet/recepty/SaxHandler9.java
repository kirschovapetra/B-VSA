 ...
 * @author vsa
 */
public class SaxHandler9 extends DefaultHandler {
    String text, currentStream, oldestMovie, currentMovie, oldestStream;
    Boolean film = false,jeMinim = false, nieDostupna = false;
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        if (localName.equals("film")) {
           ...
           if (attributes.getValue("dostupnost") != null && attributes.getValue("dostupnost").equals("nie") ) {
               nieDostupna = true;
           }
        }
    }
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        if (localName.equals("film")) {
            ...
            if (currentMovie != null && currentYear != Integer.MAX_VALUE) {
                ...
                if (currentYear < oldestYear && nieDostupna) {
